// Wait until the DOM is ready (prevents null element issues)
window.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "Profile the slowest endpoints and optimize them", archetype: "systemsSculptor" }, // ✅ fixed
  ...
  // If these are missing, nothing will work
  if (!startBtn || !landingScreen || !quizScreen) {
